...
Lightweight MADR format: **Context / Decision / Consequences**. An ADR is written when the decision is made, not reconstructed later. To change a decision, write a new ADR that supersedes the old one — don't edit history.
